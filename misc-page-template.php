...
<div class="page-hero  overlay" style="background: url(../c.eqcdn.com/_6631f2d73f69cebadfd3a44607875b9a/abcosolar/files/theme/images/hero-about.jpg);background-position: 50% 50%;background-repeat: no-repeat;background-size: cover;"></div>
    ...
    <p>Our subsidiaries offer full-service, licensed electrical contractors helping with every stage of solar panel installation; from determining the size, financing options, tax and utility incentives.</p>    <a href="subsidiaries/overview.html" class="cta">View Subsidiaries</a></div>
    <div class="side-module">
