<?php
/**
 * Template Name: SEC Filings Page Template
 *
 */
get_header(); ?>
      ...
      <div class="col-md-9 js-same-height">
        <div class="main-content">
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0" class="spr-ir-table">
            ...
            <tbody>
              <?php $secdocs = new WP_Query(array(
                  'post_type' => 'sec_filings'
                ));?>

              <? while($secdocs->have_posts()) : $secdocs->the_post();?>
                <?php $xbrl = get_field( 'xbrl-xlxs' ); ?>
                <?php $raw = get_field( 'xbrl_raw') ?>
                <tr>
